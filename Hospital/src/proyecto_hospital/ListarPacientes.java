...
public class ListarPacientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        listapac = new javax.swing.JList<>();
        ...
        jScrollPane2.setViewportView(listapac);
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try {
            for(int x=0; x< log.GetpacieSice();x++){
                String valor= log.GEtPaciente();
    ...
    private javax.swing.JList<String> listapac;
